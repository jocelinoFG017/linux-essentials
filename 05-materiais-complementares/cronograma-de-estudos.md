...
| ----------- | ------------------------------------------------- | ---------- |
| **Segunda** | **Tópico 01 – Comunidade Linux**                  | - História do Linux e filosofia do software livre<br>- Distribuições mais usadas (Ubuntu, Fedora, Debian etc.)<br>- Conceito de comunidade e colaboração em código aberto |
...
| **Sábado**  | **Revisão prática**                               | - Exercícios práticos combinando todos os tópicos:<br>  • Navegar no sistema de arquivos<br>  • Criar, mover, copiar e excluir arquivos<br>  • Alterar permissões e grupos<br>  • Conectar via SSH e usar comandos básicos de rede |
