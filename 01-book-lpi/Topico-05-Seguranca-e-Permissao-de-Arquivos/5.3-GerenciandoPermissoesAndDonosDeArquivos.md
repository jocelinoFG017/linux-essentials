...
Nesse modo, usam-se três dígitos com notação octal.
...
O primeiro dígito representa **u** (usuário), seguido de **g** (grupo) e, por fim, outros (**o**).
...
**Observação:** o comando **umask** define as permissões padrão para novos arquivos e diretórios criados.
...
- No modo numérico, usa-se a notação de quatro dígitos (ex.: 1775)
...
- No modo numérico, usa-se a notação de quatro dígitos (ex.: 2775)
...
- No modo simbólico, substitui o x pelo s
- No modo numérico, usa-se a notação de quatro dígitos (ex.: 4775)
