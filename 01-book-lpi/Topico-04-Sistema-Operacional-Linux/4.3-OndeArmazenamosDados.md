...
> **Nota:** para o Linux, **tudo** é considerado um arquivo.
...
| **/usr/local/bin**  | Tem a mesma finalidade que /usr/local/sbin, mas para programas comuns de usuário            |
...
- **Física:**  
  A RAM vem na forma de chips compostos de circuitos integrados contendo milhões de transistores e capacitores.
