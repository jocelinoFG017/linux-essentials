...
- **ping:** testa a conectividade de rede com outro host.
...
**Observação:** **ip route** e **ip route show** mostram as mesmas informações do comando **route**, de forma visualmente diferente.
