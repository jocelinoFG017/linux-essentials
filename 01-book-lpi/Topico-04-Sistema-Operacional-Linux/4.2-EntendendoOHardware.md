...
No Linux, a memória do sistema é gerenciada automaticamente: ao iniciar um aplicativo, o sistema aloca memória para ele e a libera quando o aplicativo é encerrado. Se a RAM acabar, o Linux usa a memória swap — uma área do disco — para mover temporariamente aplicativos inativos, liberando RAM. Quando esses aplicativos precisam ser executados, são trazidos de volta da swap para a memória.
...
- **Mem:** memória RAM física do seu sistema (em megabytes, porque usou -m).
    ...
    - **available:** quantidade estimada de memória disponível para novos processos sem usar swap — 2075 MB.  
      É um valor mais realista do que “free”, pois considera a memória de buff/cache que pode ser liberada.
...
- **AMD e AMD64:** indicam CPUs AMD com suporte a x86 e x64, respectivamente.
...
- **SSD:** é, grosso modo, uma versão mais sofisticada de um dispositivo de memória USB, com capacidade significativamente maior. Os SSDs armazenam informações em microchips, sem partes móveis.
