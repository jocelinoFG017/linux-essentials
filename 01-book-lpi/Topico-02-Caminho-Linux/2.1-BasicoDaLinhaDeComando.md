...
O shell é um programa que faz a comunicação por texto entre o sistema operacional e o usuário.
...
$ greeting=hello
```
> **Observação:** não coloque espaços antes ou depois do operador `=`.
...
Não utilize `$`, pois `unset` espera o nome da variável, e não seu valor.
