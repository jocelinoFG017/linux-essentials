...
> **Observação:** cada página man pertence a uma seção, mas seções diferentes podem conter páginas man com o mesmo nome. Nesse caso, ao digitar o comando, devemos adicionar o número da categoria.
...
> **Observação:** arquivos criados recentemente podem não ser encontrados. Nesse caso, devemos atualizar o banco de dados do `locate` utilizando o comando **updatedb**.
...
> **Observação:** o `find` não é tratado no exame Linux Essentials.
