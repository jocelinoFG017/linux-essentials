...
- **Beamer** → Classe LaTeX capaz de criar apresentações de slides a partir de código LaTeX.
...
- **Bitwarden** → Open source, similar ao KeePass, mas, em vez de armazenar seus dados em um arquivo, utiliza um servidor na nuvem. Dessa forma, é mais fácil manter todos os seus dispositivos sincronizados e suas senhas acessíveis pela web.
...
- **Empilhada:**
  - É implementada sobre o sistema de arquivos existente.
...
- **De bloco:**
  ...
  - dm-crypt é o padrão para esse método de criptografia e é nativo do kernel.

**VeraCrypt** → Sucessor do TrueCrypt, permite a criação de mídias e arquivos criptografados.
