...
#### Vi/Vim (Vim significa Vi Improved)
...
**Observação:** **tudo** é **tratado** como **string**, inclusive os números.
...
Ao utilizarmos mais de um argumento (`$2`, `$3` etc.), caso um deles não seja passado, será considerado nulo e não haverá mensagem de erro.
...
É possível obter a entrada do usuário do seu script e atribuí-la a uma variável por meio do comando **read**:
