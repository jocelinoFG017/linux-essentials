...
> **Observação:** sempre adiciona o conteúdo em uma nova linha.
...
São usadas para descrever trechos de texto dentro de arquivos.

As expressões regulares são utilizadas para procurar caracteres dentro de um arquivo (por exemplo, uma palavra). Ou seja, elas leem o arquivo e buscam a string especificada.
...
> **Observação:** o caractere `+` é uma expressão regular estendida, e precisamos passar a opção `-E` para o comando.
