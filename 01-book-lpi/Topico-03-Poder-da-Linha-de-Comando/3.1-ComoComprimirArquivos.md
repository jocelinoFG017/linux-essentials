...
**Lossy (Com perda):** As informações podem ser removidas do arquivo. Ele é compactado de tal forma que a descompactação resultará em um arquivo ligeiramente diferente do original.
  ...
  - Compressões com perda são frequentemente utilizadas para imagens, vídeos e áudios em que a perda de qualidade é imperceptível ao ser humano.
...
**Dica:** textos e códigos sempre usam compressão sem perda. Imagens, vídeos e áudios podem usar compressão com ou sem perda, dependendo do formato.
...
**Observação:** `-l` mostra as informações de compressão.
...
**Nota:** compactar não é o mesmo que comprimir.
---
...
> **Observação:** ao usar o `tar`, o traço (`-`) é opcional antes das opções ou flags.
