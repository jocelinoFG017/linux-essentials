...
🌐 **Acesse o site:**  
👉 https://jocelinofg017.github.io/linux-essentials/

---

## 📚 Sobre o projeto

- **Instrutor / Autor:** Jocelino Garcia  
- **Objetivo:** Preparação para a certificação **Linux Essentials (LPI)**
- **Público-alvo:** Iniciantes em Linux, estudantes de TI e candidatos à certificação
- **Formato:** Conteúdo teórico + exemplos práticos
- **Tempo estimado de estudo:** ~3 horas (leitura inicial)
...
├── 01-book-lpi/          # Conteúdos baseados em material LPI
...
Basta acessar o GitHub Pages:
https://jocelinofg017.github.io/linux-essentials/

🔹 Opção 2 — Rodar localmente
```sh
git clone https://github.com/jocelinoFG017/linux-essentials.git
cd linux-essentials
```
...
Atualmente o conteúdo está disponível em:
