...
<div class="cards-container">
  ...
  <a href="{{ '/01-book-lpi/Topico-01-Comunidade-Linux/' | relative_url }}" class="card">
    <div class="card-bg" style="background-image: url('{{ "/assets/img/topic01.webp" | relative_url }}');"></div>
    <div class="card-content">01 - Comunidade Linux</div>
  </a>

  <a href="{{ '/01-book-lpi/Topico-02-Caminho-Linux/' | relative_url }}" class="card">
    <div class="card-bg" style="background-image: url('{{ "/assets/img/topic02.webp" | relative_url }}');"></div>
  ...
  <a href="{{ '/01-book-lpi/Topico-03-Poder-da-Linha-de-Comando/' | relative_url }}" class="card">
    <div class="card-bg" style="background-image: url('{{ "/assets/img/topic03.webp" | relative_url }}');"></div>
  ...
  <a href="{{ '/01-book-lpi/Topico-04-Sistema-Operacional-Linux/' | relative_url }}" class="card">
    <div class="card-bg" style="background-image: url('{{ "/assets/img/topic04.webp" | relative_url }}');"></div>
  ...
  <a href="{{ '/01-book-lpi/Topico-05-Seguranca-e-Permissao-de-Arquivos/' | relative_url }}" class="card">
    <div class="card-bg" style="background-image: url('{{ "/assets/img/topic05.webp" | relative_url }}');"></div>
    <div class="card-content">05 - Segurança e Permissão de Arquivos</div>
  </a>

  <a href="{{ '/05-materiais-complementares/' | relative_url }}" class="card">
    <div class="card-bg" style="background-image: url('{{ "/assets/img/extras.webp" | relative_url }}');"></div>
    <div class="card-content">Extras</div>
  </a>
